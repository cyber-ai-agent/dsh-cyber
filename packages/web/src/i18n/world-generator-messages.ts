...
const catalogs = defineLocaleCatalogs({
  'zh-CN': {
    ...
    sceneTitle: '默认 2D 场景', sceneNone: '尚未选择场景', sceneHint: '从官方场景中挑选一个作为世界的默认布局，或上传自己的背景图片。', scenePick: '选择一个官方场景', sceneEmpty: '官方场景目录为空。',
    backgroundUpload: '上传背景图片', backgroundUploadHint: '支持 PNG、JPEG、WebP，最大 4 MiB。上传的图片只替换背景；站位、导航与交互点仍来自所选的官方场景。', backgroundSelected: '已选择背景图片：{name}', backgroundUploadError: '背景上传失败。请换一张 PNG、JPEG 或 WebP 图片。', backgroundTooLarge: '背景图片不能超过 4 MiB。', backgroundNeedsScene: '请先选择一个官方场景，再上传背景图片。', backgroundUseOfficial: '使用官方背景', backgroundSummary: '上传背景 {name}（布局来自 {scene}）',
  ...
  'zh-TW': {
    ...
    sceneTitle: '預設 2D 場景', sceneNone: '尚未選擇場景', sceneHint: '從官方場景中挑選一個作為世界的預設佈局，或上傳自己的背景圖片。', scenePick: '選擇一個官方場景', sceneEmpty: '官方場景目錄為空。',
    backgroundUpload: '上傳背景圖片', backgroundUploadHint: '支援 PNG、JPEG、WebP，最大 4 MiB。上傳的圖片只取代背景；站位、導航與互動點仍來自所選的官方場景。', backgroundSelected: '已選擇背景圖片：{name}', backgroundUploadError: '背景上傳失敗。請換一張 PNG、JPEG 或 WebP 圖片。', backgroundTooLarge: '背景圖片不能超過 4 MiB。', backgroundNeedsScene: '請先選擇一個官方場景，再上傳背景圖片。', backgroundUseOfficial: '使用官方背景', backgroundSummary: '上傳背景 {name}（佈局來自 {scene}）',
  ...
  'en-US': {
    ...
    sceneTitle: 'Default 2D scene', sceneNone: 'No scene selected', sceneHint: 'Pick an official scene as the default layout, or upload a background of your own.', scenePick: 'Pick an official scene', sceneEmpty: 'The official scene catalog is empty.',
    backgroundUpload: 'Upload background', backgroundUploadHint: 'PNG, JPEG, or WebP up to 4 MiB. An upload replaces the background image only; anchors, navigation and interactables still come from the official scene you picked.', backgroundSelected: 'Selected background: {name}', backgroundUploadError: 'Background upload failed. Choose a PNG, JPEG, or WebP image.', backgroundTooLarge: 'A background must be 4 MiB or smaller.', backgroundNeedsScene: 'Pick an official scene before uploading a background.', backgroundUseOfficial: 'Use the official background', backgroundSummary: 'Uploaded background {name} (layout from {scene})',
