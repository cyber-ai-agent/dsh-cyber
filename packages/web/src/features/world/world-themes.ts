...
export const sakuraShrineManifest: WorldThemeManifestV1 = {
  ...
  assets: [
    {
      id: 'sakura-scene',
      src: '/assets/skins/sakura-shrine-world.webp',
      kind: 'image',
      preload: true,
      pixelArt: false,
    },
...
export const BUILTIN_THEMES: WorldThemeConfig[] = [
  ...
  },
  {
    ...
    tokens: {
      ...
      worldMapImage: '/assets/cyber-office-world.webp',
    },
  ...
  },
  {
    ...
    tokens: {
      ...
      backdropImage: '/assets/skins/sakura-shrine-world.webp',
      backdropOpacity: 0.93,
      worldMapImage: '/assets/skins/sakura-shrine-world.webp',
    },
