...
export function WorldCanvas({
  ...
  return <><div ref={hostRef} className={`world-canvas-host${sharedScene ? ' world-canvas-host--shared-scene' : ''}`} data-theme-id={manifest.id} data-scene-id={snapshot.sceneId} aria-label="互动世界画布" onContextMenu={(event) => event.preventDefault()} />
