...
export async function inspectHarnessCandidateContract(options: {
  ...
  return {
    ...
    ...(report.releaseTag === undefined ? {} : { releaseTag: report.releaseTag }),
    ...(report.releaseDate === undefined ? {} : { releaseDate: report.releaseDate }),
    ...(report.releaseCommit === undefined ? {} : { releaseCommit: report.releaseCommit }),
    ...(report.npmChannel === undefined ? {} : { npmChannel: report.npmChannel }),
    ...(report.sessionFormatVersion === undefined ? {} : { sessionFormatVersion: report.sessionFormatVersion }),
    ...(report.supportedFormatMigrations === undefined ? {} : { supportedFormatMigrations: [...report.supportedFormatMigrations] }),
    dshBinPath,
