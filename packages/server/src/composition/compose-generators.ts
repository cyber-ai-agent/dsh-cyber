...
export type { CharacterImportAnalyzerPort, SkinImportAnalyzerPort, WorldImportAnalyzerPort }
...
/**
 * Wires the three generators (character, world, skin) to what they share.
 *
...
export function composeGenerators(options: {
  ...
  packageCatalog: CharacterGeneratorRoutesDependencies['packageCatalog'] & WorldGeneratorRoutesDependencies['packageCatalog'] & SkinGeneratorRoutesDependencies['packageCatalog']
